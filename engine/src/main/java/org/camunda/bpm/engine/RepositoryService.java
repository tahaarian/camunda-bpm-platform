...
public interface RepositoryService {
   ...
   *
   * Does not resolve mappings to case definitions.
   *
   * @param processDefinitionId id of a {@link ProcessDefinition}
   * @return a list of {@link CallActivityMapping}. <code>CallActivityMapping#getProcessDefinitionId</code> will be <code>null</code> if
